							...
							<div class="parallax-back">
								<div class="columns" >
									...
									<div class="column col-4 col-md-12 mt-2" style="border: 0px solid #ff5d8f">
										<div class="card">
											<div class="card-image" >
												<img src="<?php echo $cdnimg; ?>assets/img/shs1.jpg" class="img-responsive">
											</div>
										</div>
									</div>
									<!-- img 2 -->
									<div class="column col-4 col-md-12 mt-2" style="border: 0px solid #ff5d8f">
										<div class="card">
											<div class="card-image">
												<img src="<?php echo $cdnimg; ?>assets/img/shs2.jpg" class="img-responsive">
											</div>
										</div>
									</div>
									<!-- img 3 -->
									<div class="column col-4 col-md-12 mt-2" style="border: 0px solid #ff5d8f">
										<div class="card">
											<div class="card-image">
												<img src="<?php echo $cdnimg; ?>assets/img/shs3.jpg" class="img-responsive">
											</div>
										</div>
									</div>
									<!-- img 4 -->
									<div class="column col-4 col-md-12 mt-2" style="border: 0px solid #ff5d8f">
										<div class="card">
											<div class="card-image">
												<img src="<?php echo $cdnimg; ?>assets/img/shs4.jpg" class="img-responsive">
											</div>
										</div>
									</div>
									<!-- img 5 -->
									<div class="column col-4 col-md-12 mt-2" style="border: 0px solid #ff5d8f">
										<div class="card">
											<div class="card-image">
												<img src="<?php echo $cdnimg; ?>assets/img/shs5.jpg" class="img-responsive">
											</div>
										</div>
									</div>
								</div>
