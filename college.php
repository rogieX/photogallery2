							...
							<div class="parallax-back">
								<div class="columns" >
									...
									<div class="column col-4 col-md-12 mt-2" style="border: 0px solid #ff5d8f">
										<div class="card">
											<div class="card-image" >
												<img src="<?php echo $cdnimg; ?>assets/img/col1.jpg" class="img-responsive">
											</div>
										</div>
									</div>
									<!-- img 2 -->
									<div class="column col-4 col-md-12 mt-2" style="border: 0px solid #ff5d8f">
										<div class="card">
											<div class="card-image">
												<img src="<?php echo $cdnimg; ?>assets/img/col2.jpg" class="img-responsive">
											</div>
										</div>
									</div>
									<!-- img 3 -->
									<div class="column col-4 col-md-12 mt-2" style="border: 0px solid #ff5d8f">
										<div class="card">
											<div class="card-image">
												<img src="<?php echo $cdnimg; ?>assets/img/col3.jpg" class="img-responsive">
											</div>
										</div>
									</div>
									<!-- img 4 -->
									<div class="column col-4 col-md-12 mt-2" style="border: 0px solid #ff5d8f">
										<div class="card">
											<div class="card-image">
												<img src="<?php echo $cdnimg; ?>assets/img/col4.jpg" class="img-responsive">
											</div>
										</div>
									</div>
									<!-- img 5 -->
									<div class="column col-4 col-md-12 mt-2" style="border: 0px solid #ff5d8f">
										<div class="card">
											<div class="card-image">
												<img src="<?php echo $cdnimg; ?>assets/img/col5.jpg" class="img-responsive">
											</div>
										</div>
									</div>
								</div>
