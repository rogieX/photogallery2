							...
							<div class="parallax-back">
								<div class="columns" >
									...
									<div class="column col-4 col-md-12 mt-2" style="border: 0px solid #ff5d8f">
										<div class="card">
											<div class="card-image" >
												<img src="<?php echo $cdnimg; ?>assets/img/ele1.jpg" class="img-responsive">
											</div>
										</div>
									</div>
									<!-- img 2 -->
									<div class="column col-4 col-md-12 mt-2" style="border: 0px solid #ff5d8f">
										<div class="card">
											<div class="card-image">
												<img src="<?php echo $cdnimg; ?>assets/img/ele2.jpg" class="img-responsive">
											</div>
										</div>
									</div>
									<!-- img 3 -->
									<div class="column col-4 col-md-12 mt-2" style="border: 0px solid #ff5d8f">
										<div class="card">
											<div class="card-image">
												<img src="<?php echo $cdnimg; ?>assets/img/ele3.jpg" class="img-responsive">
											</div>
										</div>
									</div>
									<!-- img 4 -->
									<div class="column col-4 col-md-12 mt-2" style="border: 0px solid #ff5d8f">
										<div class="card">
											<div class="card-image">
												<img src="<?php echo $cdnimg; ?>assets/img/ele4.jpg" class="img-responsive">
											</div>
										</div>
									</div>
									<!-- img 5 -->
									<div class="column col-4 col-md-12 mt-2" style="border: 0px solid #ff5d8f">
										<div class="card">
											<div class="card-image">
												<img src="<?php echo $cdnimg; ?>assets/img/ele5.jpg" class="img-responsive">
											</div>
										</div>
									</div>
								</div>
